...
# LangChain imports - MODERN STYLE with compatibility
try:
    # Try modern import (LangChain >= 0.1.0)
    ...
    try:
        ...
        # Last resort - check if it's in experimental
        try:
            from langchain_experimental.agents import AgentExecutor, create_react_agent
        except ImportError:
            raise ImportError(
                "Cannot import AgentExecutor and create_react_agent. "
                "Please install: pip install langchain==0.1.20 langchain-core==0.1.52"
            )

from langchain_core.tools import Tool
# Use older, more stable imports to avoid version conflicts
try:
